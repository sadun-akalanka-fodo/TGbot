...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_message = (
        ...
        "📄 PDF OCR - Just send me a PDF and I'll extract printed English + Sinhala text\n\n"
        "Select an option from the menu below or send a PDF/video link!"
    )
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "• Just send me any PDF with printed text\n"
        "• I will extract the text and send it back in messages\n\n"
